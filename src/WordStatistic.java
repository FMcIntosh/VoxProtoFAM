...
public class WordStatistic {
    ...
    WordStatistic(String word, int level) {
        ...
        faulted = new SimpleIntegerProperty(FileModel.countOccurences(WordFile.FAULTED + "", word, level));
        failed = new SimpleIntegerProperty(FileModel.countOccurences(WordFile.FAILED, word, level));
        mastered = new SimpleIntegerProperty(FileModel.countOccurences(WordFile.MASTERED, word, level));
    }
